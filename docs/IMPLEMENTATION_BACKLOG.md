...
| DATA-01 | DB migrations and repository interfaces | BOOT-01, SPEC-02, PLATFORM-01 | FR-01/03/14 | Relational/spatial/vector schema, role permissions, migrations, source registry and trace linkage; local-only implementation, no provider resources or live persistence; see [DATA-01 assignment](assignments/DATA-01.md) | in_progress |

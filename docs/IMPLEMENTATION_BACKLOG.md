...
| DATA-02 | Normalization, chunks, entities and indexes | ING-01, L2-ADAPTER-01 | FR-03/04/06 | Stable offsets, gazetteer candidates, audience fields, embedding version/hash, invalidation and privacy filtering | planned |
| RAG-01 | Hybrid retrieval and grounded proposals | DATA-02, L2-ADAPTER-01, EVAL-01 | FR-05/06/07 | Exact/spatial/time/audience/semantic candidates; contradictory evidence; measured recall; sufficient cases produce direct proposals | planned |

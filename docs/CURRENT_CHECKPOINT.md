...
- `RAG-CORE` is also specified as a later local-only Layer 2 retrieval boundary. It can use synthetic records/vectors to preserve provenance and contradictions, but cannot claim sufficiency or measured retrieval quality before EVAL-01.

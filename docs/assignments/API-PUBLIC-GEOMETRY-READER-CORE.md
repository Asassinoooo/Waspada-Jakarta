...
- **Allowed paths:** `apps/db/migrations/012_public_geometry_reader.sql`; `apps/db/src/public-event-geometries.ts`; `apps/db/test/public-event-geometries.test.ts`; this assignment's implementation handoff only.

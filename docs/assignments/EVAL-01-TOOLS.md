...
- Tests prove synthetic/incomplete casebooks cannot pass release readiness; rights, minimum counts, two reviewers, adjudication and frozen held-out checks are separate and produce stable reason codes.

...
DATA-01 is now the next ready task and will use these documented ceilings without creating a Neon project or enabling live persistence. A reviewed checkpoint will be pushed to `origin/main` after the root acceptance documents are committed.
